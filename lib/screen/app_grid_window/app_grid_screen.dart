...
abstract class AppGridScreen extends App {
      ...
      if (state is GSData) {
        ...
        return SfDataGridTheme(
            ...
            child: SfDataGrid(
                ...
                tableSummaryRows:
                    (model!.datasource as SartexDataGridSource).sumRows,
                allowColumnsResizing: true,
                allowFiltering: true,
                allowSorting: true,
                isScrollbarAlwaysShown: true,
                onCellTap: (details) {
                  cellTap(context, details);
                },
                columnWidthMode: state.data.isEmpty
  ...
  cellTap(BuildContext context, DataGridCellTapDetails details) {
    var id = model.datasource.effectiveRows[details.rowColumnIndex.rowIndex - 1]
        .getCells()[0]
        .value;
