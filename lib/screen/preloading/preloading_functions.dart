...
class PreloadingFunction {
  ...
  void exportToExcel(BuildContext context) {
    ...
    cell.value = widget.model.editDocNum.text;
    cell.cellStyle = cellStyle;
    ...
    cell.value = widget.model.editDate.text;
    cell.cellStyle = cellStyle;
    ...
    cell.value = widget.model.editTruck.text;
    cell.cellStyle = cellStyle;
    ...
    cell.value = widget.model.editStore.text;
    cell.cellStyle = cellStyle;
    ...
    cell.value = widget.model.editReceipant.text;
    cell.cellStyle = cellStyle;
